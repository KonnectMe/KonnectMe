...
if($causes){
	...
	$content = elgg_view_form('causes/payment', array("enctype" => "multipart/form-data"));
}else{
...
$body = elgg_view_layout('content', array(
	'sidebar' => $sidebar,
	'filter_override' => elgg_view('causes/donate_tab',array('selected'=>'payment','causes' => $causes)),
	'filter_context' => 'all',
	'content' => $content,
	'title' => $title,
));
