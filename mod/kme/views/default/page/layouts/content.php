...
if($wrap){
	$content = "<div class='contentWrapper'>" . elgg_extract('content', $vars, '') . "</div>";
	$params['content_wrapper_loaded'] = true;
} else {
...
$body = $header . $filter . $content . $comments . $footer;

$params = array(
	'content' => $body,
	'sidebar' => $sidebar,
	'content_wrapper_loaded' => false,
);
if (isset($vars['class'])) {
