...
$options = array('value' => $entity->brief_description);

echo "<div class=\"sidebar-event-dateblock\">"; 
echo "<div class=\"day\">".event_start_date($entity->period_from, 'date_suffix')."</div>";
echo "<div class=\"month\">".event_start_date($entity->period_from, 'month')."</div>";
echo "</div>";
echo "<div class=\"event-title\">$title_link</div>";
echo "<div class=\"event-description\">".elgg_view("output/longtext", $options)."</div>";
echo "<br class=\"clear\"/>";
