<?php
// this view is overrided by make_payment_guest in kme_payapl
...
$button_title = elgg_echo('event:proceed');
...
//echo $accept_button = generate_paypal_form($payPalURL, $item_name, $payPalemail, $custom_values, $return_url, $cancel_url, $notify_url, $amount, $button_title, false);
